...
//id,email,password,gender,address
    public User(String USER_ID,String email,String password,char gender, String address){
        this.USER_ID=USER_ID;
        this.email=email;
        this.password=password;
        this.address=address;
...
//id,email,password,phonenumber,gender
    public User(String USER_ID,String email,String password,String phoneNumber,char gender){
        this.USER_ID=USER_ID;
        this.email=email;
        this.password=password;
        this.phoneNumber=phoneNumber;
